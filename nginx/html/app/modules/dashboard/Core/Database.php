<?php
namespace App\Modules\Dashboard\Core;
...
class Database {
    ...
    private function __construct() {
        try {
            error_log("=== Iniciando conexão com o banco de dados do Dashboard ===");
            
            // Carregar configuração global
            $database_config = dirname(dirname(dirname(dirname(__DIR__)))) . '/config/database.php';
